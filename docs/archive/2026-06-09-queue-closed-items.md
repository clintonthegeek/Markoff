# Queue — closed items archive (snapshot 2026-06-09)

> Verbatim snapshot of `docs/queue.md` taken 2026-06-09 during the
> docs-consolidation audit, before closed items were pruned from the
> live queue. Items #1–#7 and #9 (all closed), the closed sub-items of
> #8, and the historical header banners are preserved here in full.
> The live queue (`docs/queue.md`) carries only open items and the
> append-only Discipline Log.
