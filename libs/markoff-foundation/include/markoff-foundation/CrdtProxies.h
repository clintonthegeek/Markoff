...
class MARKOFF_FOUNDATION_EXPORT BufferProxy : public QObject {
    Q_OBJECT
public:
...
/// Created and owned exclusively by MarkoffDocument — do not construct directly.
class MARKOFF_FOUNDATION_EXPORT IdListProxy : public QObject {
    Q_OBJECT
public:
    quint64 editSequence() const { return m_editSequence; }
...
/// Created and owned exclusively by MarkoffDocument — do not construct directly.
class MARKOFF_FOUNDATION_EXPORT SiblingMapProxy : public QObject {
    Q_OBJECT
public:
    quint64 editSequence() const { return m_editSequence; }
